                	...
                	<div class="row m-b30">
							...
							<div class="col-md-8 col-sm-8">
								...
								<div class="wt-post-text">
                                    ...
                                    <a href="#" class="btn btn-primary site-button-secondry pull-left m-r10"><i class="fa fa-shopping-bag"></i> SOLICITAR INFORMACIÓN</a>

									<button class="btn btn-primary site-button pull-left"><i class="fa fa-cart-plus"></i> DESCARGAR ESPECIFICACIONES</button>
