						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								elseif($_GET["a"]==2){
									...
									$consulta = mysql_query("SELECT * FROM productos WHERE pro_id='".$_GET["idR"]."'",$conexion);
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input class="span12 m-wrap" name="titulo" value="<?=$resultado["pro_nombre"];?>" required>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        Medidas:(800 x 800) - Peso: (1 MB M&aacute;ximo)</label>
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <?php if($resultado["pro_imagen"]!=""){?>
                                                <img src="../../files/productos/<?=$resultado["pro_imagen"]?>" alt="" />
												<?php }else{?>
									...
									<div class="control-group">
									  <label class="control-label">Catálogo</label>
											<div class="controls">
												<input type="file" class="span4 m-wrap" name="archivo" />
											</div>

											<?php if($resultado["pro_catalogo"]!=""){?>
											<a href="../../files/productos/<?=$resultado["pro_catalogo"]?>" target="_blank"><?=$resultado["pro_catalogo"]?></a>
										<?php }?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
												<input class="span2 m-wrap" name="precio" value="<?=$resultado["pro_precio"]?>" type="text" required />
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<?php
											$cT = mysql_query("SELECT scat_id, scat_nombre, scat_descripcion, scat_opcion FROM sub_categorias WHERE scat_opcion=1",$conexion);
											if($nCat = mysql_num_rows($cT)==0){
												echo '<script type="text/javascript">window.location.href="'.$_SERVER['PHP_SELF'].'#portlet-config3"</script>';
											}
											?>
                                            <select data-placeholder="Escoja una opcion" class="chosen span4" tabindex="-1" name="categoria" required>
												<option value="">--Seleccione una opci&oacute;n--</option>
													<?php 
													while($i = mysql_fetch_array($cT)){
														if($i["scat_id"]==$resultado["pro_categoria"])
                                    ...
                                    <div class="control-group">
													...
													<div class="controls">
												       ...
												       <option value="1" <?php if($resultado["pro_activo"]==1){echo "selected";}?>>SI</option>
                                                       <option value="2" <?php if($resultado["pro_activo"]==2){echo "selected";}?>>NO</option>
													   </select>
													</div>
								  </div>
                                  <div class="control-group">
													...
													<div class="controls">
												       ...
												       <option value="1" <?php if($resultado["pro_destacado"]==1){echo "selected";}?>>SI</option>
                                                       <option value="2" <?php if($resultado["pro_destacado"]==2){echo "selected";}?>>NO</option>
													   </select>
													</div>
								  </div>
                                    <div class="control-group">
										...
										<div class="controls">
											<input class="span1" value="<?=$resultado["pro_posicion"]?>" name="posicion" type="text" required />
										</div>
									</div>
