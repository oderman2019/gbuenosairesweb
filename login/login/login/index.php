...
<head>
	<meta charset="utf-8" />
	<title>::<?=$rInfo[1]?> | Ingreso al Sistema::</title>
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="../controlador/autenticando.php" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuario" name="jUsUaRiO"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Contrase&ntilde;a" name="jClAvE"/>
					</div>
				</div>
			</div>
			...
			<div class="forget-password">
				<h4>Olvidaste la contrase&ntilde;a ?</h4>
				<p>
					haz click <a href="javascript:;"  id="forget-password">aqu&iacute;</a>
					para recuperarla
				</p>
			</div>
			<!--
		...
		<form class="form-vertical forget-form" action="index.html" method="post">
			<h3 >Olvidaste la contrase&ntilde;a ?</h3>
			<p>Ingresa tu email registrado y te enviaremos los datos.</p>
			<div class="control-group">
				<div class="controls">
					<div class="input-icon left">
