					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								elseif($_GET["a"]==2){
									echo '<input type="hidden" name="id" value="43">';
									echo '<input type="hidden" name="idR" value="'.$_GET["idR"].'">';
									echo '<input type="hidden" name="producto" value="'.$_GET["producto"].'">';
									$consulta = mysql_query("SELECT * FROM portafolio WHERE por_id=".$_GET["idR"].";",$conexion);
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input class="span12 m-wrap" name="nombre" value="<?=$resultado[1];?>">
										</div>
									</div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        Medidas:(800 x 800) - Peso: (2 MB)</label>
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <?php if($resultado["por_imagen"]!=""){?>
                                                <img src="../../files/portafolio/<?=$resultado["por_imagen"]?>" alt="" />
												<?php }else{?>
