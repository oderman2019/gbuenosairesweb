					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
                                ...
                                <?php
								if($_GET["a"]==1){
									echo '<input type="hidden" name="id" value="30">';
									$consulta = mysql_query("SELECT * FROM clientes",$conexion);
									$n = mysql_num_rows($consulta);
								}	
								elseif($_GET["a"]==2){
									echo '<input type="hidden" name="id" value="31">';
									echo '<input type="hidden" name="idR" value="'.$_GET["idR"].'">';
									$consulta = mysql_query("SELECT * FROM clientes WHERE cli_id='".$_GET["idR"]."'",$conexion);
