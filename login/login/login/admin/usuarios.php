					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
								...
								<?php
								$consulta = mysql_query("SELECT usr_id, usr_login, usr_clave, usr_nombre, usr_email, usr_tipo, usr_activo,rol_nombre FROM usuarios u INNER JOIN rol r ON u.usr_tipo=r.rol_id;",$conexion);
								?>
