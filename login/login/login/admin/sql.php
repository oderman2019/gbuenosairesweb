...
mysql_query("UPDATE informacion SET info_nombre_empresa='".mysql_real_escape_string($_POST["nomEmpresa"])."' ".$conextra." , info_email_principal='".$_POST["emailp"]."', info_telefono_principal='".$_POST["telp"]."', info_terminos_condiciones='".mysql_real_escape_string($_POST["terminos"])."', info_proteccion_datos='".mysql_real_escape_string($_POST["proteccionDatos"])."', info_preguntas_frecuentes='".mysql_real_escape_string($_POST["preguntas"])."', info_direccion='".mysql_real_escape_string($_POST["dir"])."', info_pagina_web='".mysql_real_escape_string($_POST["pagina"])."', info_logo_ancho='".$_POST["logoAncho"]."', info_logo_alto='".$_POST["logoAlto"]."', info_direccion2='".$_POST["dir2"]."' WHERE info_id=1",$conexion);
...
mysql_query("INSERT INTO productos(pro_nombre, pro_descripcion, pro_precio, pro_imagen, pro_activo, pro_posicion, pro_categoria,pro_destacado, pro_video, pro_catalogo)VALUES('".mysql_real_escape_string($_POST["titulo"])."','".mysql_real_escape_string($_POST["descripcion"])."','".$_POST["precio"]."','".$nombre."','".$_POST["activo"]."','".$_POST["posicion"]."','".$_POST["categoria"]."','".$_POST["destacado"]."','".$_POST["video"]."','".$nombreDoc."')",$conexion);
$idIte = mysql_insert_id();
	if(mysql_errno()!=0){echo mysql_error(); exit();}
...
//IMAGENES
 $archivo= $_FILES['imagen']['tmp_name']; 
  ...
  move_uploaded_file($archivo, $destino ."/".$nombre);
	...
	mysql_query("UPDATE productos SET pro_nombre='".mysql_real_escape_string($_POST["titulo"])."', pro_descripcion='".mysql_real_escape_string($_POST["descripcion"])."', pro_precio='".$_POST["precio"]."' ".$conextra." , pro_activo='".$_POST["activo"]."',pro_destacado ='".$_POST["destacado"]."', pro_posicion='".$_POST["posicion"]."', pro_categoria='".$_POST["categoria"]."', pro_video='".$_POST["video"]."' WHERE pro_id=".$_POST["idR"].";",$conexion);
	if(mysql_errno()!=0){echo mysql_error(); exit();}
  echo '<script type="text/javascript">window.location.href="productos.php"</script>';
	exit();
}
...
//IMAGENES
 $archivo= $_FILES['imagen']['tmp_name']; 
  ...
  if($nombre!=""){
	  ...
	  $refoto=mysql_fetch_array(mysql_query("SELECT red_icono FROM redes_sociales WHERE red_id=".$_POST["idR"].";",$conexion));
	  if($refoto["red_icono"]!=""){
	  //@unlink("../../files/icono-redsocial/".$refoto["red_icono"]."");
	  }
	  $conextra=", red_icono='".$nombre."'";
	  }	 
mysql_query("UPDATE redes_sociales SET red_nombre='".$_POST["nombre"]."' ".$conextra.", red_url='".$_POST["url"]."' WHERE red_id=".$_POST["idR"].";",$conexion);
	if(mysql_errno()!=0){echo mysql_error(); exit();}
  echo '<script type="text/javascript">window.location.href="redes-sociales.php"</script>';
	exit();
}
...
if($_POST["id"]==18){
	...
	if($_FILES['sonido']['name']!=""){
		$sonido = $_FILES['sonido']['name']; $destino = "../../files/musica-paginas/"; move_uploaded_file($_FILES['sonido']['tmp_name'], $destino ."/".$sonido);
	}
...
//CREAR SUBPAGINAS
if($_POST["id"]==20){
mysql_query("INSERT INTO subpaginas(sub_nombre, sub_descripcion, sub_id_pagina, sub_activa, sub_posicion,sub_url)VALUES('".mysql_real_escape_string($_POST["nombre"])."','".mysql_real_escape_string($_POST["descripcion"])."','".$_POST["paginap"]."','".$_POST["estado"]."','".$_POST["posicion"]."','paginas.php');",$conexion);
	if(mysql_errno()!=0){echo mysql_error(); exit();}
...
//EDITAR SUBPAGINAS
if($_POST["id"]==21){
mysql_query("UPDATE subpaginas SET sub_nombre='".mysql_real_escape_string($_POST["nombre"])."', sub_descripcion='".mysql_real_escape_string($_POST["descripcion"])."', sub_id_pagina='".$_POST["paginap"]."', sub_activa='".$_POST["estado"]."', sub_posicion='".$_POST["posicion"]."', sub_url='".$_POST["url"]."' WHERE sub_id=".$_POST["idR"]."",$conexion);
	if(mysql_errno()!=0){echo mysql_error(); exit();}
  echo '<script type="text/javascript">window.location.href="subpaginas.php"</script>';
	exit();
}
...
//CREAR PORTAFOLIO
if($_POST["id"]==42){
	$logo = $_FILES['imagen']['name']; $destino = "../../files/portafolio/"; move_uploaded_file($_FILES['imagen']['tmp_name'], $destino ."/".$logo);
	mysql_query("INSERT INTO portafolio(por_nombre, por_descripcion, por_imagen, por_producto)VALUES('".mysql_real_escape_string($_POST["nombre"])."','".mysql_real_escape_string($_POST["des"])."','".$logo."', '".$_POST["producto"]."')",$conexion);
	if(mysql_errno()!=0){echo mysql_error(); exit();}
