						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
										<a href="clientes-info.php?a=1" class="btn green">Agregar <i class="icon-plus"></i></a>
									</div>
									...
									<tbody>
										...
										<tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a href="sql.php?idR=<?=$resultado["cli_id"];?>&get=20" onClick="if(!confirm('Desea eliminar este registro?')){return false;}"><img src="../../files/iconos/deletle.png"></a>
                                            </td>
										</tr>
                                        <?php }?>
